...
/** RF24L01硬件接口定义 */
#define RF24L01_CE_GPIO_PORT			PTA
//#define RF24L01_CE_GPIO_CLK				RCC_APB2Periph_GPIOG
#define RF24L01_CE_GPIO_PIN				GPIO_Pin_12
#define RF24L01_CE				        (12)

#define RF24L01_IRQ_GPIO_PORT			PTA
//#define RF24L01_IRQ_GPIO_CLK			RCC_APB2Periph_GPIOG
#define RF24L01_IRQ_GPIO_PIN			GPIO_Pin_17
#define RF24L01_IRQ			            (17)

#define RF24L01_CS_GPIO_PORT			SPI_NSS_GPIO_PORT			//PTA13
...
#define RF24L01_GET_IRQ_STATUS( )		GPIO_ReadInputDataBit(RF24L01_IRQ_GPIO_PORT,RF24L01_IRQ_GPIO_PIN)	//IRQ状态
