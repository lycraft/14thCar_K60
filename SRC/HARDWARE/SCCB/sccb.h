#include "sys.h"          /* all drivers         */
#ifndef __SCCB_H
#define __SCCB_H

//SCCB ¹Ü½ÅÅäÖÃ
#define SCCB_PORT       PTB
#define SCCB_SCL        GPIO_Pin_10
#define SCCB_SDA        GPIO_Pin_11


#define SCL_H()         GPIO_SetBits(SCCB_PORT,SCCB_SCL)         
#define SCL_L()         GPIO_ResetBits(SCCB_PORT,SCCB_SCL)       


#define SDA_H()         GPIO_SetBits(SCCB_PORT,SCCB_SDA)        
#define SDA_L()         GPIO_ResetBits(SCCB_PORT,SCCB_SDA)   

/* read byte  */
#define SDA_IN()        GPIO_ReadInputDataBit(SCCB_PORT,SCCB_SDA) 

#define SDA_DDR_OUT()   SDA_OUT_Init();    
#define SDA_DDR_IN()    SDA_IN_Init();   
