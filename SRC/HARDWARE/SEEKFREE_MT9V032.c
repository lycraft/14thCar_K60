...
//uint8 	P_Pixels[Image_H][Image_W];
uint8   receive[3];
uint8   receive_num = 0;
...
{
    UART_ReceiveData(MT9V032_COF_UART,&receive[receive_num]);;
    receive_num++;
...
void camera_init(void)
{
    ...
    UART_DebugPortInit(UART3_RX_B10_TX_B11,9600);
    
    UART_ITConfig(MT9V032_COF_UART,UART_IT_RDRF,ENABLE);
