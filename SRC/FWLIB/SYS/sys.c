	...
	if(ClockOption == ClockSource_EX8M || ClockOption == ClockSource_EX50M)
	{
		...
		switch(CoreClock)
		{
			...
			case CoreClock_200M:
				...
				break;	
				case CoreClock_150M:
				MCG->C5 = (uint8_t)MCG_C5_PRDIV(14);  
				MCG->C6 = (uint8_t)(0x40u|MCG_C6_VDIV(21));
				SIM->CLKDIV1 =(SIM_CLKDIV1_OUTDIV1(0)|SIM_CLKDIV1_OUTDIV2(1)|SIM_CLKDIV1_OUTDIV3(1)|SIM_CLKDIV1_OUTDIV4(5));	
				SystemCoreClock	= 150000000;
				break;			
				case CoreClock_180M:
				MCG->C5 = (uint8_t)MCG_C5_PRDIV(14);  
				MCG->C6 = (uint8_t)(0x40u|MCG_C6_VDIV(30));
				SIM->CLKDIV1 =(SIM_CLKDIV1_OUTDIV1(0)|SIM_CLKDIV1_OUTDIV2(1)|SIM_CLKDIV1_OUTDIV3(1)|SIM_CLKDIV1_OUTDIV4(7));	
