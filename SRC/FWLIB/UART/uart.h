...
#define UART5_RX_D8_TX_D9    	 (0x000212DDU)
//						   0000 0000 0000 0010 0001 0010 1101 1101						
//    UART5_RX_E9_TX_E8    0000 0000 0000 0010 0101 0001 0001 1101
//		UART_Index-1 UART_Alt_Index-2 UART_GPIO_Index-3 UART_TX_Pin_Index-4 UART_RX_Pin_Index-5 UART_CTS_Pin_Index-6 UART_RTS_Pin_Index-7
//		地址位:            XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX
//		对应功能位:        XXX7 7777 6666 6555 5544 4443 3322 2111
...
void UART_SendData1(UART_Type* UARTx,int32 Data);
...
void uart_putbuff (UART_Type* UARTx, uint8_t *buff, uint32_t len);
void uart_putbuff1 (UART_Type* UARTx, int32 *buff, uint32_t len);
void bluetooth_sent(void);
